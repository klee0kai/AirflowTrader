...
from moex.load.daily_strategy import moex_macd_catalyzed_strategy,moex_macd_signal_strategy,moex_macd_divergence_strategy
...
with DAG('Trader_Extract_Moex',
    ...
    dag_dailyMoexMacdDivergence = PythonOperator(
        task_id="moex_daily_macd_divergence",
        op_kwargs={
            'airflow': True
        },
